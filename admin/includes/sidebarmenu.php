					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
							        ...
							        <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Manage Cupons</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										<ul id="menu-academico-sub" >
										    <li id="menu-academico-avaliacoes" ><a href="create-cupon.php">Create</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-cupon.php">Manage</a></li>
										</ul>
									</li>
